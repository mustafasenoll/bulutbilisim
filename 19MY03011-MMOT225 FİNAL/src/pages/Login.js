        ...
        return (
            <SafeAreaView style={styles.wrapper}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.description}>Size özel haber uygulaması!</Text>
                </View>
                <View style={styles.formView}>
                    ...
                    <TouchableOpacity style={styles.loginButton} onPress={this.Login}>
                        <MyButton textTitle='Oturum Aç' backgroundColor='#000' />
                    </TouchableOpacity>
                </View>
                <View style={styles.CreateAccountView}>
                    <Text>Hesabın yok mu?</Text>
                    <TouchableOpacity>
                        <Text style={styles.accountCreateText}>Şimdi Hesap Oluşturun!</Text>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
        );
